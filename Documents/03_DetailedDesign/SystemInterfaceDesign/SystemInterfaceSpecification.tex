...
\begin{longtable}{|p{2.8cm}|p{3.2cm}|p{8.0cm}|}
\hline
...
\paragraph{Dữ liệu yêu cầu (Request Payload/Parameters):}
\begin{longtable}{|p{2.8cm}|p{2.2cm}|c|p{7.0cm}|}
\hline
...
\begin{itemize}[leftmargin=*]
    \item \textit{Responses (Từ External Service)}*
\end{itemize}

\textbar{} HTTP Status \textbar{} Trường hợp \textbar{} Cấu trúc dữ liệu trả về (JSON) \textbar{}
\textbar{} :--- \textbar{} :--- \textbar{} :--- \textbar{}
\textbar{} \textbf{200 OK} \textbar{} Token hợp lệ \textbar{} \texttt{\{ "sub": "12345", "name": "Nguyễn Văn A", "given\_name": "A", "picture": "https://...", "email": "a@gmail.com", "email\_verified": true \}} \textbar{}
\textbar{} \textbf{401 Unauthorized}\textbar{} Token sai/hết hạn \textbar{} \texttt{\{ "error": "invalid\_request", "error\_description": "Invalid Credentials" \}} \textbar{}
