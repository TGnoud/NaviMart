# Class Design Specification - MasterDataUI

**Module:** Module_8_Admin
**Stereotype:** `<<boundary>>`
**Description:** Xử lý các logic và lưu trữ thông tin liên quan đến `MasterDataUI`.
...
|---|---|---|
| manageData | void | Xử lý nghiệp vụ manageData. |
...
- **Exceptions:**
  ...
  - `Exception`
- **Description:** Xử lý nghiệp vụ manageData.
