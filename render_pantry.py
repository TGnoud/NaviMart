...
puml_dir = r"D:\navimart\diagrams\New_Analysis_Class_Diagrams"
output_dir = r"D:\navimart\diagrams\New_Analysis_Class_Diagrams\images"
os.makedirs(output_dir, exist_ok=True)

# Render only UC020-UC025 (Pantry/Kho)
for f in sorted(os.listdir(puml_dir)):
    if f.endswith('.puml') and any(f.startswith(f'UC0{i}') for i in range(20, 26)):
