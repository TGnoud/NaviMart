...
Độ phủ tổng thể trên toàn bộ \code{src} đạt 61,91\% câu lệnh và 52,70\% nhánh (đo bằng \code{npm run test:cov}. Khi xét riêng theo module (Bảng~\ref{tab:cov}), các module nghiệp vụ cốt lõi --- xác thực,
